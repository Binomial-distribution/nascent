...
export const SWEET_BOYFRIEND = {
  ...
  language: "简体中文",
  subtitle: "甜系男友，黏人但不催",
  spoken: "收工了。我到家了，你在哪，过来让我抱一会儿。",
  aftercare: "我还在沙发这边。过来靠一会儿，还是先歇着，你说。",
  profile: [
...
export const PERSONA_CARDS = {
  ...
  playful: {
    ...
    language: "简体中文",
    subtitle: "爱逗你，但会看你脸色",
    spoken: "你终于舍得回我了。过来，今天想被我捉弄，还是想被哄？",
    aftercare: "好了好了，不闹了。靠过来，我给你顺顺气。",
    profile: [
  ...
  calm: {
    ...
    language: "简体中文",
    subtitle: "低语、留白，但一直在",
    spoken: "我在。你先靠近就好，想说话再说。",
    aftercare: "还在。灯可以暗一点。要不要让我抱着，还是安静待一会儿。",
    profile: [
